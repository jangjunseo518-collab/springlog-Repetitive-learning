...
public class ActivityController {
  ...
  @PostMapping
  public ResponseEntity<ActivityResponse> createActivity(@RequestBody @Valid CreateActivityRequest result) {
    ActivityResponse activity = activityService.createActivity(result);
